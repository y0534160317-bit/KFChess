...
//        System.out.println("Resource found: " + (resource != null));
    ...
    public Img render(GameSnapshot snapshot) {
        BoardView board = snapshot.getBoard();
    ...
    private void drawBoard(Img canvas, BoardView board) {
    ...
    private void drawPieces(Img canvas, BoardView board, List<ActiveMotion> motions, long currentTime, GameSnapshot snapshot) {
